...
module.exports = options => ({
  ...
  resolve: {
    ...
    alias: {
      'kilcote-components': path.resolve(__dirname, '../../app/components/'),
      'kilcote-actions': path.resolve(__dirname, '../../app/redux/actions/'),
      'kilcote-styles': path.resolve(__dirname, '../../app/styles/components/'),
      'kilcote-api': path.resolve(__dirname, '../../app/api/'),
      'kilcote-utils': path.resolve(__dirname, '../../app/utils/'),
      'kilcote-images': path.resolve(__dirname, '../../public/images/'),
      'kilcote-vendor': path.resolve(__dirname, '../../node_modules/')
    }
  },
