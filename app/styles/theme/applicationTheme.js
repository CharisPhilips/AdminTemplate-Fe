...
const applicationTheme = (paletteTotal, color, mode, direction) => ({
  direction,
  palette: {
    type: mode,
    primary: themePalette(paletteTotal, color, mode).primary,
    secondary: themePalette(paletteTotal, color, mode).secondary,
    action: {
  ...
  glow: {
    light: `0 2px 20px -5px ${themePalette(paletteTotal, color, mode).primary.main}`,
    medium: `0 2px 40px -5px ${themePalette(paletteTotal, color, mode).primary.main}`,
    dark: `0 2px 40px 0px ${themePalette(paletteTotal, color, mode).primary.main}`,
  },
  rounded: {
    small: '8px',
    medium: '12px',
  ...
  overrides: {
    ...
    MuiInput: {
      ...
      underline: {
        '&:after': {
          ...
          borderRadius: 8,
          bottom: -1,
          boxShadow: `0 0 1px ${themePalette(paletteTotal, color, mode).primary.main}`,
        },
        '&:before': {
          display: 'none'
        }
    ...
    MuiTableCell: {
      root: {
        borderBottom:
          mode === 'dark'
            ? '1px solid #636363'
            : `1px solid ${themePalette(paletteTotal, color, mode).primary.light}`,
      },
      head: {
        fontWeight: 600,
      },
    ...
    MuiPickersClock: {
      clock: {
        ...
        border: `1px solid ${themePalette(paletteTotal, color, mode).primary.main}`,
      },
    },
    MuiPickersClockPointer: {
      thumb: {
        boxShadow: `0 1px 10px 0px ${themePalette(paletteTotal, color, mode).primary.main
          }`,
      },
    },
    MuiPickerDTTabs: {
      tabs: {
        ...
        color: themePalette(paletteTotal, color, mode).primary.main,
      },
    },
    MuiExpansionPanel: {
      root: {
        ...
        '&$expanded': {
          borderRadius: 16,
          boxShadow: `0px 0px 0px 1px ${themePalette(paletteTotal, color, mode).primary.main}`,
          '& + div': {
            borderTopLeftRadius: 16,
            borderTopRightRadius: 16,
          },
    ...
    MuiDialogTitle: {
      root: {
        ...
        '&:after': {
          ...
          width: 60,
          height: 4,
          background: themePalette(paletteTotal, color, mode).primary.main,
          bottom: 0,
          left: 26,
        },
        '& h2': {
          color:
            mode === 'dark'
              ? themePalette(paletteTotal, color, mode).primary.light
              : themePalette(paletteTotal, color, mode).primary.dark,
        },
      },
    },
    MuiSnackbarContent: {
    ...
    MuiAppBar: {
      ...
      colorPrimary: {
        backgroundColor:
          mode === 'dark'
            ? themePalette(paletteTotal, color, mode).primary.dark
            : themePalette(paletteTotal, color, mode).primary.main,
      },
    },
    MuiTabs: {
      root: {
    ...
    MuiToggleButtonGroup: {
      root: {
        ...
        borderRadius: 8,
        boxShadow: 'none',
        border: `1px solid ${themePalette(paletteTotal, color, mode).secondary.main}`,
      },
    },
    MuiToggleButton: {
      root: {
        ...
        '&$selected': {
          color: themePalette(paletteTotal, color, mode).secondary.main,
          backgroundColor: themePalette(paletteTotal, color, mode).secondary.light
        }
      },
    },
    MUIDataTableToolbarSelect: {
      root: {
        ...
        backgroundColor:
          mode === 'dark'
            ? themePalette(paletteTotal, color, mode).secondary.dark
            : themePalette(paletteTotal, color, mode).secondary.light,
      },
      title: {
