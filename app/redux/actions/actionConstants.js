...
export const FETCH_THEME_COMPLETE = 'FETCH_THEME_COMPLETE';
...
export const CHECK_TREE = 'CHECK_TREE';
export const INIT_CHECK_TREE = 'INIT_CHECK_TREE';
//Auth 
...
export const REMOVE_ROW_COMPLETE = 'REMOVE_ROW_COMPLETE';
