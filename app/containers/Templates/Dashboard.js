...
import { toggleAction, openAction, playTransitionAction } from 'kilcote-actions/UiActions';
  ...
  render() {
    ...
    return (
      ...
      >
        ...
        { /* SemanticUI Left Sidebar Menu */
          layout === 'semanticui-menu' && (
            <LeftSidebarLayout
              history={history}
              toggleDrawer={toggleDrawer}
              loadTransition={loadTransition}
