...
class testSemanticUIPage extends Component {
  _isMounted = false;
  ...
  render() {
    ...
    return (
      <div>
        ...
        <PapperBlock whiteBg icon="ios-person" title="Test Semantic UI theme Page" desc="This page is to test semantic theme.">
          <div className={classes.root}>
            <Grid container direction="row" spacing={2} container justify="flex-start">
              <Grid item lg={12} md={12} sm={12} xs={12}>
                <h3 className="ui header">Go to main page:</h3>
                <Button primary onClick={() => window.open('https://react.semantic-ui.com/')}>
                  Go to Ant page
                </Button>
              </Grid>
              <Grid item lg={12} md={12} sm={12} xs={12}>
...
const testSemanticUIPageMapped = connect(
  mapStateToProps,
  mapDispatchToProps
)(testSemanticUIPage);

export default withStyles(styles)(testSemanticUIPageMapped);
